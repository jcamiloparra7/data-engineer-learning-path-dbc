...
-- MAGIC %sql
-- MAGIC CREATE OR REFRESH LIVE TABLE clickstream_raw
...
-- MAGIC %sql
-- MAGIC CREATE OR REFRESH LIVE TABLE clickstream_prepared(
...
-- MAGIC FROM live.clickstream_raw;
